...
export interface GuestsInputPropssearch {
  defaultValue: {
    guestAdults?: number;
...
const GuestsInputforsearchpage: FC<GuestsInputPropssearch> = ({
  defaultValue,
  onChange,
  ...
  const totalGuests =
    ...
    let adult=mystate.adult
    let children=mystate.childrens
   // alert(children);
  return (
          ...
          >
            ...
            <div className="flex-grow">
              <span className="block xl:text-lg font-semibold">
                {totalGuests || ""} Guests
                <input type='hidden' name='adult' value={guestAdultsInputValue}></input>
                <input type='hidden' name='children' value={guestChildrenInputValue}></input>
              </span>
...
export default GuestsInputforsearchpage;
