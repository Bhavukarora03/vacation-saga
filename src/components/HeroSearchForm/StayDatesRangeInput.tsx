...
const StayDatesRangeInput: FC<StayDatesRangeInputProps> = ({
  ...
  //alert(arrdisabledate)
  const [focusedInput, setFocusedInput] = useState(defaultFocus);
  const [stateDate, setStateDate] = useState(defaultValue);
 // alert(defaultValue.startDate)
 // alert(defaultValue.endDate)
        ...
        <div className="flex-grow">
          <span className="block xl:text-lg font-semibold">
            {stateDate.startDate
              ...
              : "Check in"}
              <input type='hidden' id="checkindate" value= {stateDate.startDate
              ? stateDate.startDate.format("DD-MMM-Y")
              : "Check in"}></input>
          </span>
        ...
        <div className="flex-grow">
          <span className="block xl:text-lg font-semibold">
            {stateDate.endDate
              ...
              : "Check out"}
               <input type='hidden' id="checkoutdate" value={stateDate.endDate
              ? stateDate.endDate.format("DD-MMM-Y")
              : "Check out"}></input>
          </span>
          <span className="block mt-1 text-sm text-neutral-400 leading-none font-light">
  ...
  //let arrdisabledate=["04-06-2022","08-06-2022"]
  return (
