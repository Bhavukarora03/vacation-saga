...
const GuestsInput: FC<GuestsInputProps> = ({
  ...
  // alert(setGuestAdultsInputValue)
  let adult
  if(cookies.get('tguest')=='null' || cookies.get('tguest')=='')
  {
   adult=-1
  }
  else
  {
    adult=cookies.get('tguest')
  }
  
  let child
  if(cookies.get('tchild')=='null' || cookies.get('tchild')=='')
  {
    child=-1
  }
  else{
    child=cookies.get('tchild')
  }
  //alert(adult)
  //alert(child)
  return (
