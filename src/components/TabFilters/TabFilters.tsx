...
const TabFilters:React.FC<Props>  = ({data}) => {
                ...
                <div className="overflow-hidden rounded-2xl shadow-xl bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-700">
                  ...
                  <div className="p-5 bg-neutral-50 dark:bg-neutral-900 dark:border-t dark:border-neutral-800 flex items-center justify-between">
                    ...
                    <ButtonPrimary
                      ...
                      onClick={()=>{
                        data(checkboxvalue,rangePrices[0],rangePrices[1],Beds,Bedrooms,Bathrooms)
                    }}
                    >
                      Apply 
                    </ButtonPrimary>
  ...
  const renderTabsPropertytype = (props: Props) => {
    const handleChangeRadio = (a) => {
      setradiobuttonvalue(a)
    };
    return (
      <Popover className="relative">
        {({ open, close }) => (
                ...
                <div className="overflow-hidden rounded-2xl shadow-xl bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-700">
                    ...
                    {typeOfpropert.map((item) => (
                      <div key={item.name} className="">
                        <RadioButton
                          ...
                          subLabel={item.description}
                          value={item.id}
                          onChange={() => handleChangeRadio(item.id)}
                        />
                      </div>
                    ))}
                  </div>
                  <div className="p-5 bg-neutral-50 dark:bg-neutral-900 dark:border-t dark:border-neutral-800 flex items-center justify-between">
                    ...
                    <ButtonPrimary
                      ...
                      sizeClass="px-4 py-2 sm:px-5"
                      onPress={()=>{
                        data(radiobuttonvalue,rangePrices[0],rangePrices[1],Beds,Bedrooms,Bathrooms)
                    }}
                    >
                      Apply
                    </ButtonPrimary>
                ...
                <div className="overflow-hidden rounded-2xl shadow-xl bg-white dark:bg-neutral-900   border border-neutral-200 dark:border-neutral-700">
                  ...
                  <div className="p-5 bg-neutral-50 dark:bg-neutral-900 dark:border-t dark:border-neutral-800 flex items-center justify-between">
                    ...
                    <ButtonPrimary
                      //onClick={close}
                      sizeClass="px-4 py-2 sm:px-5"
                      onClick={()=> { data(checkboxvalue,rangePrices[0],rangePrices[1],Beds,Bedrooms,Bathrooms); getdata()}}
                    >
                      Apply
                    </ButtonPrimary>
                  </div>
