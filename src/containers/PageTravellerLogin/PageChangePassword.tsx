...
function handleClick(event) {
   ...
   let url = fetch('https://admin.vacationsaga.com/api/traveller_changepassword_api', {  // Enter your IP address here
          ...
          <form className="grid grid-cols-1 gap-6" action="#" method="post" onSubmit={handleClick}>
            ...
            <label className="block">
              ...
              <Input
                ...
                required
              />
              <input type='hidden' name='traveller_id' value={location}></input>
            </label>
