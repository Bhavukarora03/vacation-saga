...
const SectionGridFilterCard: FC<SectionGridFilterCardProps> = ({
  ...
  const getData = () => {
    ...
    let url = 'https://admin.vacationsaga.com/api/destination_property/' + value;
  ...
  function property_typefilter(a, b, c, d, e, f) {
    ...
    let url = 'https://admin.vacationsaga.com/api/area_aminity_wise_api?area=' + value + '&aminityid=' + a + '&fromprice=' + b + '&toprice=' + c + '&bed=' + d + '&bedrooms=' + e + '&bathroom=' + f;
    let res = fetch(url).then(data => data.json()).then(data => {
      setDummyData(data)
      setdatafetchstatus(1)
