...
function handleClick(event) {
   ...
   let url = fetch('https://admin.vacationsaga.com/api/ownerotp_login', {  // Enter your IP address here
  ...
  const renderMain = () => {
    return (
      <div className="w-full flex flex-col sm:rounal-200 dark:border-neutral-700 space-y-8 px-0 sm:p-6 xl:p-8">
  ...
  return (
    <div className={`nc-CheckOutPage ${className}`} data-nc-id="CheckOutPage">
      <main className="container mb-24 lg:mb-32">
        <div className="max-w-md mx-auto space-y-6 ">{renderMain()}</div>
