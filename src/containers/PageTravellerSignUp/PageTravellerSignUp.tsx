...
const PageTravellerSignUp: FC<PageSignUpProps> = ({ className = "" }) => {
...
function handleClick(event) {
  ...
  setphonenumber(phone)
   ...
   var url = fetch('https://admin.vacationsaga.com/api/traveller_registration', {  // Enter your IP address here
...
//window.location="account-traveler";
      }
    })
    .catch((error) => {
      console.error(error);
        ...
        <div className="max-w-md mx-auto space-y-6 ">
		  ...
		  <label className="block">
            ...
            <label className="block">
              ...
              <Input type="password" className="mt-1" id="password" name="password"  required />
            </label>
            <span style={mystyle}>{message}</span>
          ...
          <span className="block text-center text-neutral-700 dark:text-neutral-300">
            ...
            <Link to="/Traveller-login">Sign in</Link>
          </span>
        </div>
      </div>
    </div>
...
export default PageTravellerSignUp;
